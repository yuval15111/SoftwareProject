...
/*
This function get value, row and column and checks if it is valid to put the value in currentSudoku[row][column]
...
otherwise - we are contine as usual.
If the val isnt valid in our board we print to the user an appropriate message.
*/
